    ...
    <>
      <UIStoreProvider>
        <ThemeProvider theme={theme}>
          <GlobalStyles />
          <ChatOverlayPanel defaultOpen={config.defaultOpen} position={config.position} offset={config.offset} />
        </ThemeProvider>
      </UIStoreProvider>
    </>
  )
...
if (typeof window !== "undefined") {
  ;(window as Window & { AIChatWidget?: ChatWidgetLoader }).AIChatWidget = chatWidget
}
