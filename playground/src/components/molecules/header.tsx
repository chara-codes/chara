...
const Header: React.FC<HeaderProps> = ({ title }) => {
  ...
  const { navigateToNewThread, navigateToHistory, navigateToSettings, navigateToConversation } = useRoutingStore()
    ...
    <HeaderContainer>
      ...
      <RightSection>
        ...
        <Tooltip text="Chat History" position="bottom" delay={500}>
          <RoundedIconButton onClick={navigateToHistory} aria-label="Chat History">
            <HistoryIcon />
          </RoundedIconButton>
        </Tooltip>
        ...
        <SettingsButtonWrapper>
          <Tooltip text="Settings" position="bottom" delay={500}>
            <RoundedIconButton onClick={navigateToSettings} aria-label="Settings">
              <DotsIcon />
            </RoundedIconButton>
          </Tooltip>
        </SettingsButtonWrapper>
