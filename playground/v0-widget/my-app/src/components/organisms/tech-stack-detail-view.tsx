...
const TechStackDetailView: React.FC<TechStackDetailViewProps> = ({ techStack, onBack }) => {
    ...
    <DetailContainer>
      <DetailHeader>
        ...
        <HeaderContent>
          <HeaderTitle>
            {techStack.icon}
            {techStack.name}
            {techStack.version && <VersionBadge>v{techStack.version}</VersionBadge>}
      ...
      <DetailContent>
        ...
        <DetailSection>
          ...
          <SectionContent>
            <Description>{techStack.longDescription || techStack.description}</Description>
          </SectionContent>
        </DetailSection>

        {/* Documentation Links Section */}
        {techStack.documentationLinks && techStack.documentationLinks.length > 0 && (
          <DetailSection>
            <SectionHeader>
                    ...
                    <ServerContent>
                      <JsonConfig
                        dangerouslySetInnerHTML={{
                          __html: highlightJson(JSON.stringify(server.configuration, null, 2)),
                        }}
                      />
                    </ServerContent>
                  </ServerItem>
