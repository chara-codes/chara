  ...
  return (
    <div className="app">
      ...
      case PreviewType.TESTS:
        return (
          <TestsPreview>
            <TestItem $passed={true}>✓ Component renders without crashing</TestItem>
            <TestItem $passed={true}>✓ Button click increments counter</TestItem>
            <TestItem $passed={false}>✗ API integration test failed</TestItem>
            <TestItem $passed={true}>✓ Form validation works correctly</TestItem>
          </TestsPreview>
        )
        ...
        return (
          <div>
            ...
            <p style={{ marginTop: 16, lineHeight: 1.6 }}>
              Documentation preview will be displayed here with API endpoints, component documentation, and usage
              examples.
            </p>
          </div>
        )
      ...
      case PreviewType.DEPLOYMENT:
        return (
          <div>
            ...
            <p style={{ marginTop: 16 }}>Deployment configuration and status will be shown here.</p>
          </div>
        )
