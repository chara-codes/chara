...
import { CodeIcon, ServerIcon, DatabaseIcon, GlobeIcon, LayersIcon } from "../components/atoms/icons"
import type { TechStackDetail } from "../components/organisms/tech-stack-detail-view"
    ...
    documentationLinks: [
      {
        ...
        description: "Official Vue.js documentation with guides and API reference",
      },
      {
        name: "Vue CLI",
  ...
  devtools(
    (set, get) => ({
      ...
      updateTechStack: (techStack: TechStackDetail) => {
        set((state) => ({
          techStacks: state.techStacks.map((stack) => (stack.id === techStack.id ? techStack : stack)),
        }))
      },
...
export const useTechStacks = () => useTechStacksStore((state) => state.techStacks)
export const useAddTechStack = () => useTechStacksStore((state) => state.addTechStack)
export const useUpdateTechStack = () => useTechStacksStore((state) => state.updateTechStack)
export const useDeleteTechStack = () => useTechStacksStore((state) => state.deleteTechStack)
export const useGetTechStackById = () => useTechStacksStore((state) => state.getTechStackById)
