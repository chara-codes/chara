              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  ...
                  <p className="text-xl text-muted-foreground">
                    Discover a platform that empowers creators, designers, and
            ...
            <div className="container">
              <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <p className="text-muted-foreground text-lg">
                  Our platform provides everything you need to design, create,
                  and innovate without limitations.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    description:
                      "Work seamlessly with team members and clients across the globe.",
                  ...
                  },
                  {
                    ...
                    description:
                      "Every detail crafted with care to provide the best user experience.",
                  ...
                  },
                  {
                    ...
                    description:
                      "Top-tier tools and resources to help you create professional-grade work.",
          ...
          <section className="py-20 bg-muted/50">
            <div className="container">
              <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <p className="text-muted-foreground text-lg">
                  Explore stunning projects created by our community of talented
                ...
                <TabsContent value="all" className="mt-0">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                      ...
                      <Card
                        key={index}
                        className="overflow-hidden group border-0 shadow-md"
                      >
          ...
          <section className="py-20 relative overflow-hidden">
            ...
            <div className="container relative z-10">
              <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <p className="text-muted-foreground text-lg">
                  Hear from the creative professionals who have transformed
                  their workflow with our platform.
                </p>
              </div>
                ...
                {[
                  {
                    ...
                    role: "Digital Artist",
                    avatar: "/business-man-portrait.png",
                    ...
                    <CardContent className="pt-6">
                      <div className="mb-4">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <Star
                            key={star}
                            className="inline-block h-5 w-5 text-yellow-500 fill-yellow-500"
                          />
                        ))}
                      </div>
          ...
          <section className="py-20 bg-muted/30">
            <div className="container">
              <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  How inspiration becomes reality
                </h2>
                <p className="text-muted-foreground text-lg">
                  Our platform guides you through every step of the creative
              ...
              <div className="relative">
                ...
                {[
                  ...
                  >
                    <div
                      className={`${index % 2 === 1 ? "md:text-right" : ""} md:ltr`}
                    >
          ...
          <section className="py-20 relative overflow-hidden">
            <div className="container relative z-10">
              <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <h2 className="text-3xl md:text-4xl font-bold mb-4">
                  Creative tools for every need
                </h2>
                <p className="text-muted-foreground text-lg">
                  Explore our suite of specialized tools designed to enhance
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <Card className="overflow-hidden border-0 shadow-lg bg-gradient-to-br from-purple-500/5 to-blue-500/5 backdrop-blur-sm">
                  ...
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground mb-4">
                      A comprehensive design environment with powerful vector
                      editing, typography controls, and layout tools.
                    </p>
                ...
                <Card className="overflow-hidden border-0 shadow-lg bg-gradient-to-br from-amber-500/5 to-red-500/5 backdrop-blur-sm">
                  ...
                  <CardContent className="p-6">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Create stunning animations and motion graphics with our
                      intuitive timeline-based editor.
                    </p>
                    <Accordion type="single" collapsible className="w-full">
                      <AccordionItem value="features">
                        <AccordionTrigger>Key Features</AccordionTrigger>
                ...
                {[
                  {
                    title: "Color Studio",
                    description:
                      "Create and manage color palettes with advanced color theory tools.",
                  ...
                  },
                  {
                    title: "Font Foundry",
                    description:
                      "Explore thousands of fonts and typography tools for perfect text design.",
                    icon: (
                      <span className="text-xl font-serif text-blue-500">
                        A
                      </span>
                    ),
                    color: "border-blue-500/20 bg-blue-500/5",
                  },
                  {
                    title: "3D Workshop",
                    description:
                      "Create and manipulate 3D models with our accessible modeling tools.",
                  ...
                  },
                  {
                    title: "Audio Lab",
                    description:
                      "Edit and enhance audio for your multimedia projects.",
                  ...
                  },
                  {
                    title: "Photo Editor",
                    description:
                      "Professional-grade photo editing with AI-powered enhancements.",
                  ...
                  },
                  {
                    ...
                    description:
                      "Create interactive prototypes for websites and applications.",
                  ...
                  <Card
                    key={index}
                    className={`border ${tool.color} hover:shadow-md transition-all duration-300`}
                  >
                    <CardHeader className="flex flex-row items-center gap-4">
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center ${tool.color}`}
                      >
                        {tool.icon}
                      </div>
          ...
          <section className="py-20 relative overflow-hidden">
            ...
            <div className="container relative z-10">
              <div className="max-w-4xl mx-auto bg-gradient-to-r from-purple-500/10 to-blue-500/10 backdrop-blur-sm border border-white/10 rounded-3xl p-12 text-center relative overflow-hidden shadow-xl">
                ...
                <Badge className="mb-4 bg-white/10 text-white backdrop-blur-sm border-white/20">
                  Join Today
                </Badge>
                ...
                <p className="text-white/70 text-lg mb-8 max-w-2xl mx-auto">
                  ...
                  and taken their projects to the next level.
                </p>
        ...
        <footer className="bg-muted/30 border-t py-12">
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Empowering creators to bring their ideas to life with powerful
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  {["About", "Careers", "Press", "Partners", "Contact"].map(
                    (item) => (
                      <li key={item}>
                        <a
                          href="#"
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              <p className="text-sm text-muted-foreground">
                © 2023 CreativeLab. All rights reserved.
              </p>
