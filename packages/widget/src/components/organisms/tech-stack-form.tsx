            ...
            {(formData.documentationLinks || []).map((link, index) => (
              <LinkItem key={index}>
                <LinkFields>
                  ...
                  <FormGroup $fullWidth>
                    <Label htmlFor={`docLink_${index}_description`}>
                      Description
                    </Label>
                    <Input
          ...
          <FormSection>
            ...
            {(formData.mcpServers || []).map((server, index) => (
              <LinkItem key={index}>
                <LinkFields>
                  <FormGroup $fullWidth>
                    <Label htmlFor={`mcpServer_${index}_name`}>
                      Server Name
                    </Label>
                    <Input
                  ...
                  <FormGroup $fullWidth>
                    <Label htmlFor={`mcpServer_${index}_config`}>
                      Configuration (JSON)
                    </Label>
                    <JsonEditor
                    ...
                    />
                    {mcpJsonErrors[index] && (
                      <ErrorMessage>{mcpJsonErrors[index]}</ErrorMessage>
                    )}
                  </FormGroup>
                </LinkFields>
