    ...
    return (
      <div className="text-xs max-w-xs">
        ...
        <div className="grid grid-cols-2 gap-x-2 gap-y-1">
          ...
          <span>{context.elementInfo.componentFramework || "Unknown"}</span>
          ...
          {context.elementInfo.relativePath && (
            <>
              ...
              <span className="font-mono text-xs bg-gray-100 px-1 rounded">{context.elementInfo.relativePath}</span>
            </>
          )}
