import type { Chat, Model, FileDiff, FileNode, ExecutedCommand } from "../store/types"
...
export async function fetchModels(): Promise<{ models: Model[]; recentModels: string[] }> {
  try {
    console.log("Attempting to fetch models from: /data/models.json")
