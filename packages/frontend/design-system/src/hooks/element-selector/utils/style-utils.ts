 ...
 */
export function generateHighlightStyles(config: ElementSelectorUIConfig): string {
  return `
    @keyframes fadeIn {
 ...
 */
export function getPrimaryButtonStyles(config: ElementSelectorUIConfig): Partial<CSSStyleDeclaration> {
  return {
 ...
 */
export function getInfoSectionStyles(config: ElementSelectorUIConfig, variant: 'element' | 'component' = 'element'): Partial<CSSStyleDeclaration> {
  const baseStyles = {
    padding: '8px 10px',
    borderRadius: '6px',
    marginBottom: '12px',
 ...
 */
export function getCursorFollowerStyles(config: ElementSelectorUIConfig): Partial<CSSStyleDeclaration> {
  return {
    position: 'fixed',
    width: '40px',
    height: '40px',
 ...
 */
export function getSelectionGuideStyles(config: ElementSelectorUIConfig): Partial<CSSStyleDeclaration> {
  return {
    position: 'fixed',
    top: '20px',
    left: '50%',
 ...
 */
export function getTagDisplayStyles(config: ElementSelectorUIConfig): Partial<CSSStyleDeclaration> {
  return {
    display: 'none',
 ...
 */
export function applyInputFocusEffects(input: HTMLInputElement, config: ElementSelectorUIConfig): void {
