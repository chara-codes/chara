...
export const simpleTextMessage = "Analyze the following PDF and generate a summary.";
...
export function hasContextAttachments(content: string | MessageContent[]): boolean {
